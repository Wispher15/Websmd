            ...
            <ul class="menu-list">
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu" style="display: none; background-color: #ffffff;">
                        <li><a href="http://103.130.242.190:8090/ReportSales" target="_blank" class="submenu-item">Sales Harian</a></li>
                        <li><a href="http://103.135.49.43:8090/dev2026/misis_2026/" target="_blank" class="submenu-item">Perbandingan 2 Bin</a></li>
                        <li><a href="http://103.135.49.43:8090/dev2026/TrendSalesUnit_2026/" target="_blank" class="submenu-item">Trend Sales Unit</a></li>
                        <li><a href="http://103.130.242.190:8090/RP32" target="_blank" class="submenu-item">P3</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu" style="display: none; background-color: #ffffff;">
                        <li><a href="http://103.135.49.43:8090/PK_2026/" target="_blank" class="submenu-item">PK</a></li>
                        ...
                        <li class="menu-item-wrapper">
                            ...
                            <ul class="submenu" style="display: none; background-color: #f8fafc; border-left: 2px solid #10b981;">
                                <li><a href="http://103.135.49.43:8090/BukuCCS/" target="_blank" class="submenu-item">Bcs</a></li>
                                <li><a href="http://103.135.49.43:8090/dev2026/CCS_2026/" target="_blank" class="submenu-item">Ccs branded</a></li>
                                <li><a href="http://103.135.49.43:8090/dev2026/CCS_2026/?P=G" target="_blank" class="submenu-item">Ccs generik</a></li>
                            </ul>
                        </li>

                        <li><a href="http://103.135.49.43:8090/dev2026/KartuMonitor_2026/" target="_blank" class="submenu-item">KMO</a></li>

                        <li class="menu-item-wrapper">
                            <a href="#" class="submenu-item dropdown-trigger" style="font-weight: 600; color: #10b981;">USI Menu <span>›</span></a>
                            <ul class="submenu" style="display: none; background-color: #f8fafc; border-left: 2px solid #10b981;">
                                <li><a href="http://103.135.49.43:8090/dev2026/USI_2026/?P=R" target="_blank" class="submenu-item">Rekap USI Rayon</a></li>
                                <li><a href="http://103.135.49.43:8090/dev2026/USI_2026/?P" target="_blank" class="submenu-item">Buat USI</a></li>
                                <li><a href="buat-uspon.html" class="submenu-item">Buat USPON</a></li>
                                <li><a href="http://103.135.49.43:8090/dev2026/ReportOutletPerSystem_2026/" target="_blank" class="submenu-item">History 3 Periode</a></li>
                            </ul>
                        </li>
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu" style="display: none; background-color: #ffffff;">
                        <li><a href="http://103.135.49.43:8090/dev2026/akunrekun_2026/rekun/" target="_blank" class="submenu-item">Kunjungan (Akun)</a></li>
