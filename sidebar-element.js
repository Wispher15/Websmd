        ...
        <div class="sidebar" style="background-color: #ffffff; border-right: 1px solid #e2e8f0; display: flex; flex-direction: column; height: 100vh;">
            ...
            <ul class="menu-list" style="flex: 1; overflow-y: auto; list-style: none; padding: 0; margin: 0;">
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu" style="display: none; background-color: #ffffff; list-style: none; padding: 0;">
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu" style="display: none; background-color: #ffffff; list-style: none; padding: 0;">
                        ...
                        <li class="menu-item-wrapper">
                            ...
                            <ul class="submenu" style="display: none; background-color: #f8fafc; border-left: 3px solid #10b981; list-style: none; padding: 0;">
                        ...
                        <li class="menu-item-wrapper">
                            ...
                            <ul class="submenu" style="display: none; background-color: #f8fafc; border-left: 3px solid #10b981; list-style: none; padding: 0;">
                                <li><a href="usi-oral.html" class="submenu-item">Rekap USI Rayon</a></li>
                                <li><a href="usi-injeksi.html" class="submenu-item">Buat USI</a></li>
                                <li><a href="usi-indeks.html" class="submenu-item">Buat USPON</a></li>
                                <li><a href="usi-indeks.html" class="submenu-item">HISTORY 3 PERIODE</a></li>
                            </ul>
                        </li>
    ...
    init() {
        ...
        triggers.forEach(t => {
            t.onclick = (e) => {
                ...
                // Logika Accordion: Sembunyikan submenu lain di level yang sama
