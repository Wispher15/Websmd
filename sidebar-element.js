class SideBar extends HTMLElement {
    connectedCallback() {
        ...
        <div class="sidebar">
            ...
            <ul class="menu-list">
                <li><a href="index.html" class="menu-item" id="nav-index">Pengumuman!!</a></li>
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="usi-oral.html" class="submenu-item">USI</a></li>
                    </ul>
                </li>
                ...
                <li class="menu-item-wrapper">
                    ...
                    <ul class="submenu">
                        ...
                        <li><a href="master-outlet.html" class="submenu-item">Master Outlet</a></li>
                    </ul>
                </li>

                <li><a href="stok-distributor.html" class="menu-item" id="nav-stok">Stok Distributor</a></li>
    ...
    setActiveMenu() {
        ...
        links.forEach(link => {
            if (link.getAttribute('href') === currentPage) {
                ...
                // Buka submenu jika item yang aktif ada di dalamnya
